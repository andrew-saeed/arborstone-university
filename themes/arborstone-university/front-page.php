...
<? while( have_posts() ): the_post(); ?>
    ...
    <section id="page-banner">
        <div id="page-banner__bg" style="background-image: url(<?= get_theme_file_uri('/images/office.webp') ?>)"></div>
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide relative">
                        ...
                        <div class="h-[33.125rem] bg-cover bg-center" style="background-image: url(<?= get_theme_file_uri('images/university-1.webp') ?>);"></div>
                    </div>
                    <div class="swiper-slide relative">
                        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-3/4 bg-black/80 text-white-light text-center px-4 py-12 space-y-6">
                        ...
                        <div class="h-[33.125rem] bg-cover bg-center" style="background-image: url(<?= get_theme_file_uri('images/university-2.webp') ?>);"></div>
                    </div>
                    <div class="swiper-slide relative">
                        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full md:w-3/4 bg-black/80 text-white-light text-center px-4 py-12 space-y-6">
                        ...
                        <div class="h-[33.125rem] bg-cover bg-center" style="background-image: url(<?= get_theme_file_uri('images/university-3.webp') ?>);"></div>
                    </div>
                </div>

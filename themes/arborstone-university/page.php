...
<? while( have_posts() ): the_post(); ?>
    ...
    <main>
        <div id="main-box" class="relative max-w-screen-lg mx-auto px-2 py-14">
            <? if($pageParent): ?>
                <nav class="invisible lg:visible absolute top-0 left-0 translate-x-2 -translate-y-1/2" aria-label="breadcrumb">

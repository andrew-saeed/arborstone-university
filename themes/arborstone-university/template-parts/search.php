<div 
    ...
    x-data="{
        ...
        toggle() {
            this.open = !this.open
            document.body.style.overflowY = this.open ? 'hidden' : 'scroll'
        }
    }" 
>
    <svg id="search-btn" width="100%" height="100%" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" @click="toggle()"> 

                            ...
                            <div class="note-box">
                                ...
                                <div class="footer-btns" x-cloak x-show="editMode">
                                    <button class="btn btn--small btn--blue with-icon right-left-margin-1" @click="updateItem">
                                        ...
                                        <span x-text="processing? 'updating' : 'update'"></span>
                                    </button>
                                </div>
                            </div>
                        </li>

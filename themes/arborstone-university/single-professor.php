...
<? while( have_posts() ): the_post(); ?>
    ...
    <main>
        <div id="main-box">
            ...
            <div id="professor-like" class="flex justify-end" x-data="professorLike" data-user-has-data="<?= $userHasData->found_posts; ?>" data-count="<?= $professorLikes->found_posts; ?>">
            ...
            <div class="after:table after:clear-both mt-4">
